...
import { ShieldCheck, Loader2, Eye, EyeOff, AlertCircle, ArrowRight } from "lucide-react";
        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-slate-500 text-xs mt-1">Sign in with administrative privileges to manage hostel tickets</p>
                </div>
